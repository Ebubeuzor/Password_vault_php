<?php
    ...
    if (isset($_SESSION['USERID'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $change->changeEmail($_POST['email'],$user['userID']);
        }
    }
?>
    <!-- register area -->
        ...
        <div id="row" class="row m-0">
            <div class="register-con">
                <div class="text-center pd-5">
                    <p class="p-1 m-0 font-ubuntu text-black-50">Change your User Email</p>
                </div>
                <div class="sub-prev-con">
                    <form method="post" enctype="multipart/form-data" id="reg-form">
                        ...
                        <div class="form-row my-4">
                            <div class="col">
                                <input type="text" value="<?php echo isset($user['email']) ? $user['email'] : 'email'?>"  name="email" id="email" class="form-control" />
                            </div>
                        </div>
